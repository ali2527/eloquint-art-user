...
function ContestLogs() {
    ...
    const getAllContest = async (pageNumber, pageSize, search, reset = false) => {
      setLoading(true);
      try {
        const response = await Get(CONTEST.getAllMyContests,token, {
          page: pageNumber
            ? pageNumber.toString()
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: "title",
        key: "title",
        render: (value, item, index) => <>{item.contest.title}</>,
      },
      {
        title: "PARTICIPATING DATE",
        dataIndex: "createdAt",
        key: "createdAt",
      ...
      },
      {
        ...
        dataIndex: "fee",
        key: "fee",
        render: (value, item, index) => <>{dayjs(item.contest.startDate).format("MM/DD/YYYY")}</>,
      },
      {
        title: "END DATE",
        dataIndex: "prize",
      ...
      },
      {
        ...
        dataIndex: "endDate",
        key: "endDate",
        render: (value, item, index) => <>${item.contest.prize}</>,
      },
  
      {
        ...
        dataIndex: "endDate",
        key: "endDate",
        render: (value, item, index) => <>{item?.entry_status }</>,
      },
      {
        title: "Action",
        dataIndex: "_id",
          ...
          <Space size="middle">
            <Dropdown
              menu={{
                items,
                onClick: ({key}) => {
                    setSelectedContest(item.contest._id)
  ...
  return (
    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-lg-12">
                <h2 class="page-heading">Contest Logs</h2>
            </div>
        </div>
